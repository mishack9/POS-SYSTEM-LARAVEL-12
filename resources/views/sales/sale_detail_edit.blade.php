     ...
     <div class="content-wrapper">
         ...
         <div class="content-header">
             <div class="container-fluid">
                 <div class="row mb-2">
                     <div class="col-sm-6">
                         <h1 class="m-0">Update Sales Detail</h1>
                     </div>
                     <div class="col-sm-6">
                         <ol class="breadcrumb float-sm-right">
                             <li class="breadcrumb-item"><a href="#">Sales_Detail</a></li>
                         ...
                         <div class="card card-outline card-primary">
                             <div class="card-header border-transparent">
                                 ...
                                 <div class="card-tools">
                                     <a href="{{ url('admin/sale/detail/' .$getDetail->sales_id) }}" class="btn btn-tool btn-primary">
                                         Go Back
                                     </a>
                               ...
                               <form class="form-horizontal" method = "POST" action = "{{ url('admin/sale/detail/edit/' .$getDetail->id)}}">
                                 {{ csrf_field() }}
                                 <div class="card-body">
                                     <input type="hidden" name = "sales_id" value="{{ $getDetail->sales_id }}">
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-10">
                                             <input type="number" class="form-control" id="selling_price" placeholder=""
                                                 name = "selling_price"  value="{{ $getDetail->selling_price }}">
                                         </div>
                                     </div>
                                      ...
                                      <div class="form-group row">
                                         ...
                                         <div class="col-sm-10">
                                             <input type="number" class="form-control" id="discount" placeholder=""
                                                 name = "discount" value="{{ $getDetail->discount }}">
                                         </div>
                                     </div>
                                 ...
                                 <div class="card-footer">
                                     ...
                                     <a href="{{ url('admin/sale/detail/' .$getDetail->sales_id) }}"
