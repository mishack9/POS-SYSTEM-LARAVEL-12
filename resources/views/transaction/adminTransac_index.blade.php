     ...
     <div class="content-wrapper">
         ...
         <div class="content-header">
             <div class="container-fluid">
                 <div class="row mb-2">
                     <div class="col-sm-6">
                         <h1 class="m-0">Transaction Area</h1>
                     </div>
                     <div class="col-sm-6">
                             ...
                             <div class="card-header border-transparent">
                                 ...
                                 <div class="card-tools">
                                     ...
                                     <button class="btn btn-sm btn-primary" data-toggle="modal"
                                         data-target="#modal-secondary">Add_New_Transaction <i
                                             ...
                                             @forelse ($getRecord as $data)
                                                 <tr>
                                                     ...
                                                     <th class="text-center">
                                                        ...
                                                        <select name="" id="{{ $data['id'] }}" class="form-control changeStatus" style="width: 150px;">
                                                            <option {{ ($data['payment_status'] == '0') ? 'selected' : '' }} value="0">Pending</option>
                                                            <option {{ ($data['payment_status'] == '1') ? 'selected' : '' }} value="1">Completed</option>
                                                        </select>
     ...
     <script type="text/javascript">
       ...
       /*  alert(status_id); */
         $.ajax({
            ...
            type: 'GET',
            url: "{{ url('admin/transaction/index_status') }}",
            data: { status_id: status_id, order_id: order_id },
            dataType: 'JSON',
            success: function(data)
            {
                alert('Paymet Status Changed Successfully...');
