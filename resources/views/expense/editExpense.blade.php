                 ...
                 <div class="row">
                     <div class="col-md-12 col-lg-12 col-sm-12">
                         <div class="card card-outline card-primary">
                             ...
                             <form class="form-horizontal" method = "POST" action = "{{ url('admin/expenseUpdate/'.$getRecord['id']) }}">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $getRecord['id'] }}" id="">
                                <div class="card-body">
                                     <div class="form-group row">
                                         <label for="expense_title" class="col-sm-2 col-form-label">Expense Title :</label>
                                         <div class="col-sm-10">
                                             <input type="text" class="form-control" id="expense_title"name = "expense_title" value="{{ $getRecord['expense_title'] }}">
                                         </div>
                                     </div>
                                      <div class="form-group row">
                                         ...
                                         <div class="col-sm-10">
                                             <input type="number" class="form-control" id="expense_price"
                                                 placeholder="" name = "expense_price" value="{{ $getRecord['expense_price'] }}">
                                         </div>
                                     </div>
                                     <div class="form-group row">
                                         <label for="expense_description" class="col-sm-2 col-form-label">Expense Description :</label>
                                         <div class="col-sm-10">
                                             <textarea name="expense_description" class="form-control" id="expense_description">{{ $getRecord['expense_description'] }}</textarea>
                                         </div>
                                     </div>
