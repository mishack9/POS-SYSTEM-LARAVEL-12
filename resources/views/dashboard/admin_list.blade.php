                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('dashboard/admin_list') }}">Home</a></li>
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">
                                        {{ !empty($product_count) ? $product_count : '0' }}
                                        <small></small>
                                    </span>
                                </div>
                            </div>
                        ...
                        <a href="{{ url('admin/purchase/index') }}">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span
                                        class="info-box-number">{{ !empty($purchase_count) ? $purchase_count : '0' }}</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ url('admin/sales/index') }}">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{ !empty($sale_count) ? $sale_count : '0' }}</span>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3">
                        <a href="{{ url('admin/supplier/index') }}">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Suppplier</span>
                                    <span class="info-box-number">{{ !empty($supplier) ? $supplier : '0' }}</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ url('admin/transaction/index') }}">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">
                                        {{ !empty($wallet_total) ? number_format($wallet_total, 2) : '0' }}
                                        <small></small>
                                    </span>
                                </div>
                            </div>
